...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    let bundle = concat!(
        ...
        "return h('main',null,",
        "h('section',{'data-hyper-state':'default'},",
        "h('button',{type:'button','data-primary-action':'true'},'Run fixture'),",
        "h('p',null,'Artifact quality summary')),",
        "h('section',{hidden:true,'data-hyper-state':'empty'},",
        "h('p',{'data-hyper-state-feedback':'true'},'No generated results yet.')),",
        "h('section',{hidden:true,'data-hyper-state':'loading','aria-busy':'true'},",
        "h('p',{role:'status','data-hyper-state-feedback':'true'},'Loading generated results.')),",
        "h('section',{hidden:true,'data-hyper-state':'error'},",
        "h('p',{role:'alert','data-hyper-state-feedback':'true'},'Generated results could not be loaded.')),",
        "h('section',{hidden:true,'data-hyper-state':'disabled'},",
        "h('p',{'data-hyper-state-feedback':'true'},'Generation is unavailable.'),",
        "h('button',{type:'button',disabled:true},'Generate')));",
        "});"
    );
    let css = concat!(
        "#root{box-sizing:border-box;padding:24px;}",
        "main,section{display:flex;flex-direction:column;align-items:flex-start;gap:16px;",
        "max-width:100%;}",
