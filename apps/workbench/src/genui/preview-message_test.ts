  ...
  assertEquals(
    parsePreviewMessage({
      ...
      observation: {
        ...
        content_fixture_digest: "c".repeat(64),
        content_fixture_target_count: 2,
        content_fixture_applied_count: 2,
        content_fixture_cjk_label_count: 1,
        content_fixture_long_content_count: 1,
        declared_state_target_count: 0,
        declared_state_applied_count: 0,
        declared_state_semantic_count: 0,
  ...
  assertEquals(
    parsePreviewMessage({
      ...
      observation: {
        ...
        focus_target_count: 0,
        focus_visible_count: 0,
        content_fixture_target_count: 0,
        content_fixture_applied_count: 0,
        content_fixture_cjk_label_count: 0,
        content_fixture_long_content_count: 0,
        declared_state_digest: "d".repeat(64),
        declared_state_target_count: 1,
        declared_state_applied_count: 1,
        declared_state_semantic_count: 1,
        console_error_count: 0,
        resource_failure_count: 0,
        layout_shift_milli: 0,
        semantic_digest: "b".repeat(64),
